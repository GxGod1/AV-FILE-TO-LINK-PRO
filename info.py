...
# 👑, Channels & Logs
BIN_CHANNEL = int(environ.get("BIN_CHANNEL", '-1002912169906'))  # File storage channel
LOG_CHANNEL = int(environ.get("LOG_CHANNEL", '-1002889264563'))  # General log channel
PREMIUM_LOGS = int(environ.get("PREMIUM_LOGS", '-1002889264563'))  # Premium user actions log
VERIFIED_LOG = int(environ.get('VERIFIED_LOG', '-1002889264563'))  # Verified user actions log
SUPPORT_GROUP = int(environ.get("SUPPORT_GROUP", "-1003050333829"))
...
AUTH_CHANNEL = list(map(int, environ.get("AUTH_CHANNEL", "-1002992708220").split()))  # Allowed channels for authorization

# username add without @
OWNER_USERNAME = environ.get("OWNER_USERNAME", '@Wwwwwwwidj2o')  # Owner's username
BOT_USERNAME = environ.get("BOT_USERNAME", 'Jsjdjsjsjdjbot')  # Bot's username
